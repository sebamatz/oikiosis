...
να βάζεις σε λόγια όλα αυτά που ζεις τώρα.

Θα διαβάσω ο ίδιος το μήνυμά σου
και θα σου απαντήσω μέσα από αυτό το chat,
με ένα μήνυμα μόνο για σένα
και με 1–2 μικρά, ξεκάθαρα βήματα
για το «τι κάνω τώρα».

Μέχρι τότε, δεν χρειάζεται να πάρεις
όλες τις αποφάσεις ούτε να απαντήσεις σε όλους.
Το σημαντικό είναι ότι έκανες αυτό το βήμα.`;
