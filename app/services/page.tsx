  ...
  const services = [
    {
      ...
      description: [
        ...
        "Σε αυτή τη φάση σε βοηθάω να σταθείς όρθιος, να μειώσουμε λίγο την ένταση μέσα σου και να πάρουμε μαζί τις πρώτες πρακτικές αποφάσεις για τις επόμενες ώρες και μέρες.",
        'Αυτή είναι η επείγουσα υπηρεσία "First Responder" του μοντέλου R.M.',
        "Εφαρμόζουμε άμεσα το πρωτόκολλο S.O.S. (Ασφάλεια, Προσανατολισμός, Σταθεροποίηση) για να μειώσουμε την ταχύτητα της κρίσης, να διαχειριστούμε το χάος του διαζυγίου υψηλής σύγκρουσης και να σχεδιάσουμε την «Πυξίδα των 72 Ωρών» σου.",
    ...
    },
    {
      ...
      description: [
        "Αφού σβήσουμε τη «φωτιά» της κρίσης, χρειάζεται ένας χώρος για να ξαναβρεις τον εαυτό σου.",
        "Εδώ δουλεύουμε πιο ήρεμα, με τον δικό σου ρυθμό, αυτά που άφησε πίσω της η σύγκρουση: την ταυτότητά σου, τις σχέσεις σου, την εμπιστοσύνη στον εαυτό.",
        "Εδώ εφαρμόζουμε πλήρως τον Χάρτη 5 Φάσεων (R.E.A.C.H.).",
        "Πλοηγούμαστε μαζί σε κάθε βήμα (Ρύθμιση, Απο-σύμπλεξη, Ανασύνδεση, Συνεπίλυση, Αναδόμηση), με τελικό στόχο μια βιώσιμη, νέα κανονικότητα.",
    ...
    },
    {
      ...
      description: [
        ...
        "Εδώ δεν προσπαθούμε να σας κάνουμε «φίλους», αλλά να χτίσουμε έναν λειτουργικό, παιδοκεντρικό τρόπο συνεργασίας.",
        ...
        "Σας εκπαιδεύουμε σε εργαλεία πλοήγησης (BIFF, S.A.F.E.) και χτίζουμε ένα πλάνο που λειτουργεί σαν σταθερό «λειτουργικό σύστημα» για τη συν-γονεϊκότητα.",
      ],
    },
    {
      ...
      description: [
        ...
        "Σκοπός εδώ είναι να δυναμώσουμε τις ρίζες, πριν η ένταση γίνει καταιγίδα.",
