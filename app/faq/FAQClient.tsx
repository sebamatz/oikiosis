    ...
    items: [
      {
        ...
        a: "Είναι εξειδικευμένη ψυχολογική πλοήγηση για γονείς και εμπλεκόμενους που βρίσκονται σε δικαστικές διαδικασίες υψηλής σύγκρουσης. Στόχος δεν είναι η ψυχοθεραπεία με ανασκαφή παρελθόντος, αλλά η ψυχολογική σταθεροποίηση και η λειτουργικότητα μέσα στη διαδικασία.",
      },
      {
        q: "Είναι το ίδιο με forensic αξιολόγηση ή πραγματογνωμοσύνη;",
        a: "Όχι, και αυτό είναι σημαντικό να το ξέρεις. Ο forensic ψυχολόγος αξιολογεί την υπόθεση ή το άτομο για λογαριασμό του δικαστηρίου, ως ουδέτερος εμπειρογνώμονας. Εγώ είμαι ο ψυχολόγος σου και δουλεύω για σένα, για να παραμείνεις λειτουργικός και σταθερός μέσα στη διαδικασία. Δεν αξιολογώ την υπόθεση. Δεν εκδίδω πραγματογνωμοσύνη.",
      },
      {
