  ...
  const faqSchema = {
    ...
    mainEntity: [
      ...
      },
      {
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text: "Όχι. Ο Γιάννης Γιαννόπουλος δεν εκδίδει πραγματογνωμοσύνη. Είναι ο ψυχολόγος του εμπλεκόμενου — δουλεύει για τη λειτουργικότητά του, όχι για αξιολόγηση της υπόθεσης.",
        },
      },
    ],
  };
