...
const FAQ_DATA: FAQCategory[] = [
  {
    ...
    items: [
      ...
      {
        q: "Σε ποιες περιπτώσεις ενδείκνυται η εξειδίκευσή σας;",
        plainAnswer:
    ...
    items: [
      {
        ...
        plainAnswer:
          "Είναι θεραπευτικό μοντέλο σχεδιασμένο από τον Ιωάννη Γιαννόπουλο. Η κρίση έχει δύναμη — τη χρησιμοποιούμε για αλλαγή, βήμα βήμα.",
        a: (
          <>
            Είναι θεραπευτικό μοντέλο σχεδιασμένο από τον{" "}
            <Link
              href="/about"
              className="text-primary hover:underline font-medium transition-colors"
            >
            ...
            . Η κρίση έχει δύναμη — τη χρησιμοποιούμε για αλλαγή, βήμα βήμα.
          </>
        ),
      },
      {
        ...
        plainAnswer:
          "Είναι ο βασικός οδηγός, αλλά χρησιμοποιούμε και συστημική, trauma-informed πρακτικές και τεχνικές ρύθμισης.",
        a: (
          <>
            Είναι ο βασικός οδηγός, αλλά χρησιμοποιούμε και συστημική,{" "}
            <Link
              href="/about#model"
              className="text-primary hover:underline font-medium transition-colors"
            >
      ...
      {
        q: "Τι είναι η R.E.A.C.H.;",
        a: "Είναι η δομημένη ατομική διαδρομή μας σε 5 φάσεις: Ρύθμιση, Επεξεργασία, Ανασύνδεση, Ανάκαμψη, Ανθεκτικότητα.",
      },
    ],
  },
  {
  ...
  {
    id: "zeugaria",
    title: "Ζευγάρια & Νομικές",
    items: [
      {
        q: "Θεραπεία ζεύγους και μετά τον χωρισμό;",
        a: "Ναι, μέσω Θεραπείας Χωρισμού. Στόχος είναι μια πιο καθαρή μετάβαση, ειδικά για τα παιδιά.",
      },
      {
        q: "Συνεργασία με δικηγόρο;",
        a: "Ναι. Σε στηρίζουμε ψυχολογικά και, αν θες, επικοινωνούμε με το νομικό σου γραφείο.",
      },
      {
  ...
  },
  {
    ...
    items: [
      {
        q: "Τι είναι το S.O.S.;",
        a: "Είναι δωρεάν πρώτη επαφή. Γράφεις τι σε δυσκολεύει, απαντάμε εντός εργάσιμης ημέρας, χωρίς δέσμευση.",
      },
      {
