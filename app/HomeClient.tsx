...
export default function HomeClient() {
  return (
    <>
      ...
      {/* Three Ways Section */}
      <WaysToSupport title="Πώς μπορείς να έχεις στήριξη από εμάς" />
      ...
      >
        <div className="mx-auto max-w-4xl">
          <div className="text-center mb-12">
            <Link
              href="/testimonials"
              className="inline-block cursor-pointer mb-6 text-3xl underline font-bold md:text-4xl bg-linear-to-r from-primary to-primary/60 bg-clip-text text-transparent"
            >
      ...
      <Section>
        <div className="mx-auto max-w-4xl text-center flex flex-col items-center">
          ...
          <Button
            size="lg"
            variant="outline"
            className="mb-4 max-w-100 w-full whitespace-normal hover:text-primary overflow-hidden border-primary/20 hover:bg-primary/5"
            asChild
          >
            <Link
              href="/first-session"
