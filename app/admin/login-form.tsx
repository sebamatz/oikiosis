    ...
    <div className="flex items-center justify-center h-[calc(100vh-64px)] bg-linear-to-br from-slate-900 to-slate-800 pb-40">
      ...
      <div className="w-full max-w-sm px-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          {/* INPUT: Pure White Background, Dark Text */}
          <input
            type="password"
            value={password}
            onChange={(e) => setPassword(e.target.value)}
            placeholder="Enter Password"
            className="w-full p-4 bg-white text-gray-900 rounded-xl focus:outline-none focus:ring-4 focus:ring-blue-500/50 shadow-lg placeholder:text-gray-400"
            autoFocus
          />
